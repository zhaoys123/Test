...
public class Person extends Model<Person>{
	 ...
	 * 分页查询
	 */
	public Page<Person> paginate(int pageNumber, int pageSize,Object hospitalid) {
		
		Page<Person> pagePerson=paginate(pageNumber, pageSize, "select * ", "from gc_schedule_person where hospitalid= '"+hospitalid+"' order by pid desc");
		return pagePerson;
	}
