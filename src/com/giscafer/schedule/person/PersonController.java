...
public class PersonController extends Controller{
	public void index() {
		...
		setAttr("personPage", Person.me.paginate(getParaToInt(0, 1), 10,attribute));
		render("person.html");
	}
	public void add(){
	...
	public void pageSelectPerson() throws IOException{
		...
		Page<Person> personPage=Person.me.paginate(page, rows,attribute);
	...
	public void queryPerson() throws IOException{
		...
		if(getPara()==null){
			queryFilter.setWhereString("1=1 and hospitalid = '"+attribute+"'");
		}else{
